                          ...
                          className={
                            ...
                            {this.state.headers.map((obj, dataIndex, arr) => (
                              ...
                              {obj.key === "yourCost" && rowData.savedCost
                                  ? <span className="desktop-view icon icon-money"></span>
                                  : ""}
                                {rowData[obj.key]}
                                <br/>
                                {obj.key === "status" && rowData.claimAppealed
                                  ? <span className="desktop-view"><span className="icon icon-filled orange icon-exclamation-circle right-1x" aria-label="warning" tabIndex="0"></span>{t('table:table.claimapplead')}</span>
                                  : ""}
                              </td>
                            ))}
                            {this.props.showDetails &&
